 (function(h, e) {
     ...
     function ca(a, b) {
         ...
         this.update = function(a) {
             if (!1 !== c.enabled) {
                 ...
                 } else 180 == c.screenOrientation ? (n = new e.Vector3(1, 0, 0), h.setFromAxisAngle(n, k)) : 90 == c.screenOrientation ? (n = new e.Vector3(0, 1, 0), h.setFromAxisAngle(n, k)) : -90 == c.screenOrientation && (n = new e.Vector3(0, 1, 0), h.setFromAxisAngle(n, -k));
                 v.multiply(h);
                 v.multiply(r);
                 D.set(g, b, -f, "YXZ");
                 m.setFromEuler(D);
     ...
     z.prototype = Object.assign(Object.create(e.Sprite.prototype), {
         ...
         addHoverElement: function(a, b, x) {
             b = void 0 === b ? 40 : b;
             this.element || (this.element = a.cloneNode(!0), this.element.style.display = "none", this.element.style.top = 0, this.element.style.position = "absolute", this.element.classList.add("panolens-infospot"), this.element.style.left = x + "px", this.element.verticalDelta = b)
         },
     ...
     I.prototype = Object.assign(Object.create(e.EventDispatcher.prototype), {
         ...
         createVideoControlSeekbar: function() {
             ...
             function b(a) {
                 e && (l = ((a.clientX || a.changedTouches && a.changedTouches[0].clientX) - p) / f.clientWidth, l = m + l, l = 1 < l ? 1 : 0 > l ? 0 : l, f.setProgress(l), g.dispatchEvent({
                     type: "panolens-viewer-handler",
     ...
     B.prototype = Object.assign(Object.create(n.prototype), {
         ...
         load: function() {
             ...
             e = function() {
                 ...
                 this.isMobile() && (k.pause(), d && b ? this.dispatchEvent({
                     type: "panolens-viewer-handler",
                     method: "updateVideoPlayButton",
                     data: !1
                 }) : this.dispatchEvent({
     ...
     da.prototype = Object.assign(Object.create(e.EventDispatcher.prototype), {
         ...
         disableEffect: function() {
             this.mode !== t.NORMAL && (this.mode = t.NORMAL, this.disableReticleControl(), this.activateWidgetItem(void 0, this.mode), this.dispatchEventToChildren({
                 type: "panolens-dual-eye-effect",
                 mode: this.mode
